...
export default new ChatInput(
  {
    name: 'kiss',
    description: 'Embrassez un autre utilisateur',
    options: [
      {
        name: 'cible',
  ...
  async (interaction) => {
    ...
    try {
      ...
      const actionText = `${interaction.user} a embrassé ${targetUser} <:zrougelovii:1260653164487770193>`;
      ...
      console.error('Erreur lors de l’interaction "kiss":', error);

...
export default new ChatInput(
  {
    name: 'hug',
    description: 'Faites un câlin à un autre utilisateur',
    options: [
      {
        name: 'cible',
  ...
  async (interaction) => {
    ...
    try {
      ...
      const actionText = `${interaction.user} a fait un câlin à ${targetUser} <:zrougelovii:1260653164487770193>`;
      ...
      console.error('Erreur lors de l’interaction "hug":', error);
